<cfcomponent output="false">
	...
	<cffunction name="validateUser" access="public" output="false" returntype="array">
		...
		<cfquery name="LoginUser" datasource="petregister">
		SELECT FirstName, LastName,LoginEmail,Password
		FROM UserInfo
	...
	<!---log the user in--->
	<cflogin>
		<cfloginuser name= "#LoginUser.FirstName# #LoginUser.LastName#" password= "#LoginUser.Password#" />
